module View.EditProduct exposing (view)
...
view model =
    div [ class "uk-margin" ]
        ...
        , convertMsgHtml EditProductMsg (convertMsgHtml Pages.EditProduct.ProductMsg (Views.Product.view model.productComponent))
        ]
